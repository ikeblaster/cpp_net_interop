...
{ 
    ...
    {      
        ...
        public Genericclass<string> GetGenericWithString() {
        ...
        public List<int> listGetInts() 
        {
            return new List<int>() { 2, 3, 5, 7, 11, 13, 17 };
        }  
        
        public List<string> listGetString() 
        {
            return new List<string>() { "dva", "tri", "5", "7", "11", "13", "17" };
        } 
        
        public void listSetInts(List<int> list) 
        {
        ...
        public void listSetStrings(List<string> list) 
        {
            foreach (var e in list)
            {
                Console.WriteLine(e);
