...
Arrays::Arrays(std::wstring name) {
...
Arrays::Arrays(std::wstring name, std::wstring password) {
	::System::String^ __Param_name = _marshal_as<::System::String^>(name);
...
Arrays::Arrays(std::vector<std::wstring> names, int password) {
...
Arrays::Arrays(bool cond, std::vector<int> ints) {
...
Wrapper::MyCorp::TheProduct::SomeModule::Utilities::Simple* Arrays::get_s() {
...
void Arrays::set_s(Wrapper::MyCorp::TheProduct::SomeModule::Utilities::Simple* value) {
...
void Arrays::set_Name(std::wstring value) {
...
void Arrays::callbackSet(std::wstring mode, std::wstring (*cb)(std::wstring str, int i)) {
...
void Arrays::listSetInts(std::vector<int> list) {
...
void Arrays::listSetStrings(std::vector<std::wstring> list) {
...
void Arrays::test(std::vector<std::vector<std::wstring>> strs) {
