...
ref class PrintCallback_IL {
	public:
		...
		std::wstring (*cb)(std::wstring str, int i);

		PrintCallback_IL(std::wstring (*cb)(std::wstring str, int i)) {
			this->cb = cb;
		}
...
template <>
struct _marshal_helper<::MyCorp::TheProduct::SomeModule::Utilities::Arrays::PrintCallback^, std::wstring (*)(std::wstring str, int i)>
{
	inline static ::MyCorp::TheProduct::SomeModule::Utilities::Arrays::PrintCallback^ marshal(std::wstring (*from)(std::wstring str, int i))
	{
